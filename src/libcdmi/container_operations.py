...
class ContainerOperations(object):
    ...
    def create(self, remote_container, metadata={}):
        ...
        req = CDMIRequestWithMethod(self.endpoint + remote_container, 'PUT',
    ...
    def read(self, remote_container):
        ...
        req = CDMIRequestWithMethod(self.endpoint + remote_container, 'GET',
                                    headers=headers)
    ...
    def delete(self, remote_container):
        ...
        req = CDMIRequestWithMethod(self.endpoint + remote_container + '/',
                                    'DELETE')
